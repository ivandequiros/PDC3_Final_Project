...
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        ...
        <h1 class="text-4xl font-black text-[#1e3a8a] mt-3 tracking-tight">Register New Supply</h1>
        ...
        <form action="{{ route('products.store') }}" method="POST" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" placeholder="e.g. Mongol Pencil #2 (12pcs)" required 
                ...
                <div>
                    ...
                    <input type="number" name="current_price" step="0.01" placeholder="0.00" required 
                ...
                <div>
                    ...
                    <input type="number" name="stock_level" placeholder="0" required 
